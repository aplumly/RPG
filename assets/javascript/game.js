...
//              others: }
    ...
    function calculate_percentage(hp,constitution) //make a hp bar... preferably after four way cobat is implemented
      {   return ((hp*100)/constitution);}
//array for storing pixel data generated by python script
//
var b=0;
var cave_pixels = new Array("wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","wall","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","cave_entrance","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","ground","wall","ground","ground","ground","ground","ground","ground","wall","boss0","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","wall","ground","wall","ground","ground","ground","wall","ground","ground","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","wall","ground","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","ground","ground","ground","wall","wall","wall","wall","wall","ground","ground","wall","ground","ground","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","wall","wall","wall","wall","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","ground","wall","ground","ground","ground","wall","boss1","wall","ground","ground","wall","wall","ground","wall","wall","wall","wall","wall","ground","ground","wall","ground","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","wall","wall","ground","ground","ground","wall","wall","wall","ground","ground","wall","ground","ground","wall","ground","ground","ground","wall","ground","ground","wall","ground","ground","wall","wall","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","wall","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","ground","ground","wall","ground","ground","ground","ground","ground","ground","wall","ground","ground","wall","ground","wall","ground","wall","wall","wall","wall","wall","wall","ground","wall","wall","wall","wall","ground","ground","ground","wall","ground","ground","ground","ground","wall","wall","ground","wall","wall","ground","ground","wall","wall","wall","wall","wall","wall","wall","wall","ground","ground","wall","ground","wall","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","ground","ground","ground","wall","ground","ground","wall","wall","wall","wall","ground","ground","ground","ground","caveking","wall","wall","ground","ground","ground","ground","ground","ground","wall","ground","wall","ground","wall","ground","wall","wall","wall","wall","ground","ground","ground","wall","wall","ground","ground","ground","ground","ground","wall","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","wall","wall","ground","ground","wall","wall","wall","wall","wall","wall","ground","wall","ground","wall","ground","ground","ground","ground","wall","wall","wall","wall","wall","wall","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","wall","ground","ground","ground","wall","wall","ground","wall","wall","wall","wall","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","wall","ground","ground","wall","ground","ground","ground","wall","ground","ground","ground","ground","wall","wall","ground","wall","wall","ground","ground","wall","ground","ground","ground","ground","wall","wall","wall","wall","wall","ground","wall","wall","ground","wall","wall","ground","ground","ground","ground","ground","wall","wall","wall","wall","ground","ground","ground","wall","ground","ground","ground","ground","wall","wall","ground","ground","wall","ground","ground","cave_door","ground","ground","ground","wall","wall","ground","ground","ground","wall","ground","boss2","wall","ground","wall","wall","wall","wall","wall","wall","ground","ground","ground","ground","ground","ground","ground","ground","wall","boss3","wall","ground","ground","wall","wall","ground","ground","wall","ground","ground","wall","ground","ground","ground","wall","ground","ground","ground","ground","wall","wall","wall","wall","ground","ground","ground","ground","ground","ground","wall","wall","ground","ground","ground","ground","ground","ground","ground","wall","wall","wall","ground","ground","wall","wall","ground","ground","ground","ground","ground","wall","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","ground","wall","wall","ground","wall","wall","wall","wall","wall","wall","wall","wall","ground","ground","ground","ground","wall","ground","ground","ground","ground","ground","wall","wall","ground","ground","ground","ground","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall");
...
var impassable_types = new Array("cave_door","mountain","water","river","wall");
var event_types= new Array("cave_entrance","key","chest","healer","port","playerstart","rock golem quary","haunted graveyard","pirate cove","necromancer's thicket","quest","sidequest","trader1","trader2","cave");
var event_combat= new Array("boss1","boss2","boss3","boss4","caveking","rock golem quary","haunted graveyard","pirate cove","necromancer's thicket")
...
//on ready
    ...
    //draw map
    function draw_map(x){estate.length=0;
        estateid.length=0;
    for(let i=0;i<x.length;i++)
    {   for(let a=0;a<event_types.length;a++)
        {
            if(x[i]==event_types[a]){estate.push(i);estateid.push(x[i]);}
        }
        var pixel = $("<div>");
        pixel.addClass(x[i]);
...
var playersprite;
    ...
    player_position = $(x).attr("data-number");
    $(x).prepend(playersprite);
    playerposid = "#pos"+player_position;
    }
    spawn_player(".playerstart");
        ...
        for(let i=0;i<estate.length;i++)
        {
            if(x==estate[i]){
                if(completed.some(arrVal => estateid[i] === arrVal)){console.log("completed")}
                    ...
                    if(estateid[i]=="cave"){$("body").empty();draw_map(cave_pixels);spawn_player(".cave_entrance");}
                    else{if(estateid[i]=="cave_entrance"){$("body").empty();draw_map(pixels);spawn_player(".cave");}
                    else{
  ...
  /*  function echeck(x)
    ...
    */
    ...
    {   
        ...
        if(event_type=="trader1"||event_type=="trader2"){message_box.text("this feature is not implemented yet");}
        if(event_type=="port"||event_type=="cave"){message_box.text("this feature is not implemented yet");}
        if(event_type=="quest"||event_type=="sidequest"){message_box.text("this feature has not been implemented yet");}}
